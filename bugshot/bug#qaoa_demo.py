...
if __name__=="__main__":
    problem = {
      'Z0 Z4':0.73,'Z0 Z5':0.33,'Z0 Z6':0.5,'Z1 Z4':0.69,'Z1 Z5':0.36,
    ...
    print('cnt 0001111:', result.get('0001111', 0), ' prob:', result.get('0001111', 0) / 100)
    print('cnt 1110000:', result.get('1110000', 0), ' prob:', result.get('0001111', 0) / 100)

    from pyqpanda.Visualization import draw_probability_dict
    draw_probability_dict(result)
